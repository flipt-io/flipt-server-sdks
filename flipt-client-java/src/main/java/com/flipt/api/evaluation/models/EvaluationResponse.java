...
public class EvaluationResponse {
    ...
    public EvaluationResponse(@JsonProperty("type") String type, @JsonProperty("booleanResponse") Optional<BooleanEvaluationResponse> booleanResponse, @JsonProperty("variantResponse") Optional<VariantEvaluationResponse> variantResponse, @JsonProperty("errorResponse") Optional<ErrorEvaluationResponse> errorResponse) {
        this.type = type;
