...
public class Main {
    public static void main(String[] args) {
        ...
        EvaluationRequest booleanEvaluationRequest = new EvaluationRequest("default", "flag_boolean", "entity",
                context);
        EvaluationRequest errorEvaluationRequest = new EvaluationRequest("default", "flag1234", "entity",
                new HashMap<>());
        ...
        VariantEvaluationResponse variantEvaluationResponse = fliptClient.evaluation()
                .variant(variantEvaluationRequest);
        BooleanEvaluationResponse booleanEvaluationResponse = fliptClient.evaluation()
                .booleanEvaluation(booleanEvaluationRequest);
